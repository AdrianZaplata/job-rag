...
_ALIAS_GROUPS: list[list[str]] = [
    ...
    ["sql", "postgresql", "postgres", "mysql", "sql generation"],
    ...
    ["agents", "ai agents", "llm agents", "autonomous agents", "agentic frameworks", "agentic ai"],
    ["function calling", "tool use", "tool calling", "tools", "tool integration", "api calling"],
