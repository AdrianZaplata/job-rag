...
1. (RESOLVED: see CONTEXT.md addendum A1) **ACA Consumption outbound IP — Path A vs Path C?**
...
2. (RESOLVED: see CONTEXT.md addendum A2) **Is the GitHub repo `adrianzaplata/job-rag` public or private?**
...
3. (RESOLVED: see CONTEXT.md addendum A3) **Two-pass apply — TF-native or script-driven?**
...
4. (RESOLVED: see CONTEXT.md addendum A4) **Where does the GHA App Registration live — workforce or External tenant?**
...
5. (RESOLVED: see CONTEXT.md addendum A5) **AVM Postgres module's `server_configuration` shape — verify exact key names**
