...
- [ ] 04.1-03-PLAN.md — Wrap MSAL bootstrap chain in `frontend/src/main.tsx` with try/catch + `BootErrorFallback` so top-level rejection doesn't leave a blank `<div id="root">`
